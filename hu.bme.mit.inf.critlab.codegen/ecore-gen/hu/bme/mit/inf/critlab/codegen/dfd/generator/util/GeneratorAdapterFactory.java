...
public class GeneratorAdapterFactory extends AdapterFactoryImpl {
	...
	protected GeneratorSwitch<Adapter> modelSwitch =
		new GeneratorSwitch<Adapter>() {
			@Override
			public Adapter casePIDGenerator(PIDGenerator object) {
				return createPIDGeneratorAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link hu.bme.mit.inf.critlab.codegen.dfd.generator.PIDGenerator <em>PID Generator</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPIDGeneratorAdapter() {
		return null;
	}
